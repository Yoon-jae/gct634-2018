...
A file for training beat-synchronous chroma and exporting.
Please check the MODE and DEVICE first before you run this code.
Following three lines are different compared to 'main_beatsync.py'.

 MODE = 'frame'
 EXPORT_DIR = './export/baseline_frame_result/'
 acc_test, pred_test = data_manager.frame_accuracy(chord_test, pred_test, mode=MODE)
'''
import os
import argparse
import numpy as np
